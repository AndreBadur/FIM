        ...
        <div className="relative flex-1 bg-[url('/farm.jpg')] bg-cover bg-center h-screen p-4">
          ...
          <div className="absolute top-4 right-4 flex space-x-6 z-20">
            <div className="flex flex-col items-center">
              <span className="text-white text-sm mb-1">Já possui conta?</span>
              <button
            ...
            <div className="flex flex-col items-center">
              <span className="text-white text-sm mb-1">Ainda não?</span>
              <button
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-center">
            <h1 className="text-white text-4xl font-bebas">Bem-vindo ao FIM!</h1>
